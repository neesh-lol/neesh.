        ...
        <div className="px-5 py-5 space-y-5">
          ...
          <div className="space-y-2 text-xs text-zinc-500">
            ...
            <div className="flex flex-wrap gap-x-3 gap-y-1">
              <Link to="/terms" className="underline hover:text-white transition-colors" target="_blank">Terms of Service</Link>
              <Link to="/privacy" className="underline hover:text-white transition-colors" target="_blank">Privacy Policy</Link>
              <Link to="/community-guidelines" className="underline hover:text-white transition-colors" target="_blank">Community Guidelines</Link>
              <Link to="/refund-policy" className="underline hover:text-white transition-colors" target="_blank">Refund Policy</Link>
            </div>
          </div>
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <span className="text-xs text-zinc-400 leading-relaxed group-hover:text-zinc-300 transition-colors">
              ...
              <Link to="/terms" className="underline text-white" target="_blank">Terms of Service</Link>,{' '}
              <Link to="/privacy" className="underline text-white" target="_blank">Privacy Policy</Link>,{' '}
              <Link to="/community-guidelines" className="underline text-white" target="_blank">Community Guidelines</Link>,
...
function PremiumPage() {
  ...
  const benefits = [
    { icon: BadgeCheck, label: 'Verified Badge', desc: 'Stand out everywhere with a white verified checkmark' },
    { icon: Palette, label: 'Profile Customization', desc: 'GIF avatars, profile banners, and custom theme colors' },
    { icon: MessageSquare, label: 'Exclusive Members Chat', desc: 'Access the premium-only community channel' },
    { icon: Shield, label: 'Streak Protection', desc: '3 monthly streak freezes for missed days' },
    { icon: Eye, label: 'Profile Views', desc: 'See who viewed your profile' },
    { icon: Star, label: 'Premium Identity', desc: 'Enhanced profile card and social presence' },
  ]
      ...
      <div className="max-w-lg mx-auto w-full px-5 py-8 space-y-8">
        ...
        {status?.isFounder && (
          <div className="bg-gradient-to-r from-yellow-500/10 to-amber-500/10 border border-yellow-500/30 rounded-xl p-5">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-sm font-semibold text-yellow-400">Founder Account</h2>
            </div>
            <p className="text-xs text-zinc-400">
              You have permanent NEESH.+ access as a founder. All premium features are unlocked for life.
            </p>
          </div>
        )}
          ...
          <div className="bg-gradient-to-r from-white/5 to-zinc-800/50 border border-white/20 rounded-xl p-5">
            ...
            {status.hasStripeSubscription && (
              <button
                ...
                className="mt-3 flex items-center gap-2 text-xs text-zinc-400 hover:text-white transition-colors disabled:opacity-50"
              >
        ...
        {!status?.isPremium && (
          <div className="text-center space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-2">Upgrade to neesh.+</h2>
              <p className="text-sm text-zinc-500">Unlock premium social features</p>
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 bg-white text-zinc-950 font-semibold rounded-xl text-sm hover:bg-zinc-200 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              <Crown size={16} />
              Get neesh.+
            </button>
        ...
        <div className="space-y-3">
          <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wider">What you get</h3>
        ...
        {status?.isPremium && (
          <div className="space-y-3">
            <h3 className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Quick access</h3>
            <button
